    ...
    <AboutContainer className="about">
      <section className="sections">
        ...
        <div className="aboutme">
          <p>
            Trabalhar com react e react native, visando adquirir experiência
            profissional e mais conhecimento na area de tecnologia da
            informação, contribuindo para os ganhos e desenvolvimento do local
            de trabalho através de minhas qualificações, disposição e
            determinação.
          </p>
        ...
        <div className="timeline">
          <div className="itm-card frst">
            ...
            <h4 className="title_header">
              DESENVOLVEDOR WEB FRONT-END(Remoto)
            </h4>
            <p>
              Desenvolvimento em React e Node do Site da Empresa
              <br />
              Desenvolvimento em React Native (Android e IOS) apps para uso
              interno da Empresa
              <br />
      ...
      <section className="sections">
        ...
        <div className="timeline">
          <div className="itm-card frst">
            ...
            <p>
              A Graduação em Engenharia de Computação estuda as técnicas,
              métodos e ferramentas matématicas, fisicas e computacionais para o
